 ...
 * <ul>
 *   <li>{@link org.foxbpm.model.bpmn.foxbpm.impl.MessageObjImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.foxbpm.model.bpmn.foxbpm.impl.MessageObjImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.foxbpm.model.bpmn.foxbpm.impl.MessageObjImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link org.foxbpm.model.bpmn.foxbpm.impl.MessageObjImpl#getDataVariable <em>Data Variable</em>}</li>
 *   <li>{@link org.foxbpm.model.bpmn.foxbpm.impl.MessageObjImpl#getTargetProcess <em>Target Process</em>}</li>
 *   <li>{@link org.foxbpm.model.bpmn.foxbpm.impl.MessageObjImpl#getTargetNode <em>Target Node</em>}</li>
 *   <li>{@link org.foxbpm.model.bpmn.foxbpm.impl.MessageObjImpl#getProcessInstanceVariable <em>Process Instance Variable</em>}</li>
 *   <li>{@link org.foxbpm.model.bpmn.foxbpm.impl.MessageObjImpl#getTokenVariable <em>Token Variable</em>}</li>
 *   <li>{@link org.foxbpm.model.bpmn.foxbpm.impl.MessageObjImpl#getMessageType <em>Message Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MessageObjImpl extends MinimalEObjectImpl.Container implements MessageObj {
	/**
	...
	protected EClass eStaticClass() {
		return FoxBPMPackage.Literals.MESSAGE_OBJ;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FoxBPMPackage.MESSAGE_OBJ__ID, oldId, id));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FoxBPMPackage.MESSAGE_OBJ__NAME, oldName, name));
	}
	...
	public NotificationChain basicSetDocumentation(Documentation newDocumentation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FoxBPMPackage.MESSAGE_OBJ__DOCUMENTATION, oldDocumentation, newDocumentation);
	...
	public void setDocumentation(Documentation newDocumentation) {
		if (newDocumentation != documentation) {
			...
			if (documentation != null)
				msgs = ((InternalEObject)documentation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FoxBPMPackage.MESSAGE_OBJ__DOCUMENTATION, null, msgs);
			if (newDocumentation != null)
				msgs = ((InternalEObject)newDocumentation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FoxBPMPackage.MESSAGE_OBJ__DOCUMENTATION, null, msgs);
			msgs = basicSetDocumentation(newDocumentation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FoxBPMPackage.MESSAGE_OBJ__DOCUMENTATION, newDocumentation, newDocumentation));
	}
	...
	public EList<DataVariable> getDataVariable() {
		if (dataVariable == null) {
			dataVariable = new EObjectContainmentEList<DataVariable>(DataVariable.class, this, FoxBPMPackage.MESSAGE_OBJ__DATA_VARIABLE);
		}
		return dataVariable;
	}
	...
	public void setTargetProcess(String newTargetProcess) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FoxBPMPackage.MESSAGE_OBJ__TARGET_PROCESS, oldTargetProcess, targetProcess));
	}
	...
	public void setTargetNode(String newTargetNode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FoxBPMPackage.MESSAGE_OBJ__TARGET_NODE, oldTargetNode, targetNode));
	}
	...
	public NotificationChain basicSetProcessInstanceVariable(ProcessInstanceVariable newProcessInstanceVariable, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FoxBPMPackage.MESSAGE_OBJ__PROCESS_INSTANCE_VARIABLE, oldProcessInstanceVariable, newProcessInstanceVariable);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setProcessInstanceVariable(ProcessInstanceVariable newProcessInstanceVariable) {
		if (newProcessInstanceVariable != processInstanceVariable) {
			...
			if (processInstanceVariable != null)
				msgs = ((InternalEObject)processInstanceVariable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FoxBPMPackage.MESSAGE_OBJ__PROCESS_INSTANCE_VARIABLE, null, msgs);
			if (newProcessInstanceVariable != null)
				msgs = ((InternalEObject)newProcessInstanceVariable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FoxBPMPackage.MESSAGE_OBJ__PROCESS_INSTANCE_VARIABLE, null, msgs);
			msgs = basicSetProcessInstanceVariable(newProcessInstanceVariable, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FoxBPMPackage.MESSAGE_OBJ__PROCESS_INSTANCE_VARIABLE, newProcessInstanceVariable, newProcessInstanceVariable));
	}
	...
	public NotificationChain basicSetTokenVariable(TokenVariable newTokenVariable, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FoxBPMPackage.MESSAGE_OBJ__TOKEN_VARIABLE, oldTokenVariable, newTokenVariable);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTokenVariable(TokenVariable newTokenVariable) {
		if (newTokenVariable != tokenVariable) {
			...
			if (tokenVariable != null)
				msgs = ((InternalEObject)tokenVariable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FoxBPMPackage.MESSAGE_OBJ__TOKEN_VARIABLE, null, msgs);
			if (newTokenVariable != null)
				msgs = ((InternalEObject)newTokenVariable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FoxBPMPackage.MESSAGE_OBJ__TOKEN_VARIABLE, null, msgs);
			msgs = basicSetTokenVariable(newTokenVariable, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FoxBPMPackage.MESSAGE_OBJ__TOKEN_VARIABLE, newTokenVariable, newTokenVariable));
	}
	...
	public void setMessageType(String newMessageType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FoxBPMPackage.MESSAGE_OBJ__MESSAGE_TYPE, oldMessageType, messageType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FoxBPMPackage.MESSAGE_OBJ__DOCUMENTATION:
				return basicSetDocumentation(null, msgs);
			case FoxBPMPackage.MESSAGE_OBJ__DATA_VARIABLE:
				return ((InternalEList<?>)getDataVariable()).basicRemove(otherEnd, msgs);
			case FoxBPMPackage.MESSAGE_OBJ__PROCESS_INSTANCE_VARIABLE:
				return basicSetProcessInstanceVariable(null, msgs);
			case FoxBPMPackage.MESSAGE_OBJ__TOKEN_VARIABLE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FoxBPMPackage.MESSAGE_OBJ__ID:
				return getId();
			case FoxBPMPackage.MESSAGE_OBJ__NAME:
				return getName();
			case FoxBPMPackage.MESSAGE_OBJ__DOCUMENTATION:
				return getDocumentation();
			case FoxBPMPackage.MESSAGE_OBJ__DATA_VARIABLE:
				return getDataVariable();
			case FoxBPMPackage.MESSAGE_OBJ__TARGET_PROCESS:
				return getTargetProcess();
			case FoxBPMPackage.MESSAGE_OBJ__TARGET_NODE:
				return getTargetNode();
			case FoxBPMPackage.MESSAGE_OBJ__PROCESS_INSTANCE_VARIABLE:
				return getProcessInstanceVariable();
			case FoxBPMPackage.MESSAGE_OBJ__TOKEN_VARIABLE:
				return getTokenVariable();
			case FoxBPMPackage.MESSAGE_OBJ__MESSAGE_TYPE:
