 ...
 * <ul>
 *   <li>{@link org.foxbpm.model.bpmn.foxbpm.impl.SkipStrategyImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link org.foxbpm.model.bpmn.foxbpm.impl.SkipStrategyImpl#isIsCreateSkipProcess <em>Is Create Skip Process</em>}</li>
 *   <li>{@link org.foxbpm.model.bpmn.foxbpm.impl.SkipStrategyImpl#getSkipAssignee <em>Skip Assignee</em>}</li>
 *   <li>{@link org.foxbpm.model.bpmn.foxbpm.impl.SkipStrategyImpl#getSkipComment <em>Skip Comment</em>}</li>
 *   <li>{@link org.foxbpm.model.bpmn.foxbpm.impl.SkipStrategyImpl#isIsEnable <em>Is Enable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SkipStrategyImpl extends MinimalEObjectImpl.Container implements SkipStrategy {
	/**
	...
	protected EClass eStaticClass() {
		return FoxBPMPackage.Literals.SKIP_STRATEGY;
	}
	...
	public NotificationChain basicSetExpression(Expression newExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FoxBPMPackage.SKIP_STRATEGY__EXPRESSION, oldExpression, newExpression);
	...
	public void setExpression(Expression newExpression) {
		if (newExpression != expression) {
			...
			if (expression != null)
				msgs = ((InternalEObject)expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FoxBPMPackage.SKIP_STRATEGY__EXPRESSION, null, msgs);
			if (newExpression != null)
				msgs = ((InternalEObject)newExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FoxBPMPackage.SKIP_STRATEGY__EXPRESSION, null, msgs);
			msgs = basicSetExpression(newExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FoxBPMPackage.SKIP_STRATEGY__EXPRESSION, newExpression, newExpression));
	}
	...
	public void setIsCreateSkipProcess(boolean newIsCreateSkipProcess) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FoxBPMPackage.SKIP_STRATEGY__IS_CREATE_SKIP_PROCESS, oldIsCreateSkipProcess, isCreateSkipProcess));
	}
	...
	public NotificationChain basicSetSkipAssignee(SkipAssignee newSkipAssignee, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FoxBPMPackage.SKIP_STRATEGY__SKIP_ASSIGNEE, oldSkipAssignee, newSkipAssignee);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSkipAssignee(SkipAssignee newSkipAssignee) {
		if (newSkipAssignee != skipAssignee) {
			...
			if (skipAssignee != null)
				msgs = ((InternalEObject)skipAssignee).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FoxBPMPackage.SKIP_STRATEGY__SKIP_ASSIGNEE, null, msgs);
			if (newSkipAssignee != null)
				msgs = ((InternalEObject)newSkipAssignee).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FoxBPMPackage.SKIP_STRATEGY__SKIP_ASSIGNEE, null, msgs);
			msgs = basicSetSkipAssignee(newSkipAssignee, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FoxBPMPackage.SKIP_STRATEGY__SKIP_ASSIGNEE, newSkipAssignee, newSkipAssignee));
	}
	...
	public NotificationChain basicSetSkipComment(SkipComment newSkipComment, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FoxBPMPackage.SKIP_STRATEGY__SKIP_COMMENT, oldSkipComment, newSkipComment);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSkipComment(SkipComment newSkipComment) {
		if (newSkipComment != skipComment) {
			NotificationChain msgs = null;
			if (skipComment != null)
				msgs = ((InternalEObject)skipComment).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FoxBPMPackage.SKIP_STRATEGY__SKIP_COMMENT, null, msgs);
			if (newSkipComment != null)
				msgs = ((InternalEObject)newSkipComment).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FoxBPMPackage.SKIP_STRATEGY__SKIP_COMMENT, null, msgs);
			msgs = basicSetSkipComment(newSkipComment, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FoxBPMPackage.SKIP_STRATEGY__SKIP_COMMENT, newSkipComment, newSkipComment));
	}
	...
	public void setIsEnable(boolean newIsEnable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FoxBPMPackage.SKIP_STRATEGY__IS_ENABLE, oldIsEnable, isEnable));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FoxBPMPackage.SKIP_STRATEGY__EXPRESSION:
				return basicSetExpression(null, msgs);
			case FoxBPMPackage.SKIP_STRATEGY__SKIP_ASSIGNEE:
				return basicSetSkipAssignee(null, msgs);
			case FoxBPMPackage.SKIP_STRATEGY__SKIP_COMMENT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FoxBPMPackage.SKIP_STRATEGY__IS_CREATE_SKIP_PROCESS:
				return isIsCreateSkipProcess();
			case FoxBPMPackage.SKIP_STRATEGY__SKIP_ASSIGNEE:
				return getSkipAssignee();
			case FoxBPMPackage.SKIP_STRATEGY__SKIP_COMMENT:
				return getSkipComment();
			case FoxBPMPackage.SKIP_STRATEGY__IS_ENABLE:
				return isIsEnable();
		}
