 ...
 * <ul>
 *   <li>{@link org.foxbpm.model.bpmn.foxbpm.impl.ReceiveMessageImpl#getMessageId <em>Message Id</em>}</li>
 *   <li>{@link org.foxbpm.model.bpmn.foxbpm.impl.ReceiveMessageImpl#getFilterConditions <em>Filter Conditions</em>}</li>
 *   <li>{@link org.foxbpm.model.bpmn.foxbpm.impl.ReceiveMessageImpl#getProcessInstanceVariable <em>Process Instance Variable</em>}</li>
 *   <li>{@link org.foxbpm.model.bpmn.foxbpm.impl.ReceiveMessageImpl#getTokenVariable <em>Token Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReceiveMessageImpl extends MinimalEObjectImpl.Container implements ReceiveMessage {
	...
	protected EClass eStaticClass() {
		return FoxBPMPackage.Literals.RECEIVE_MESSAGE;
	}
	...
	public void setMessageId(String newMessageId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FoxBPMPackage.RECEIVE_MESSAGE__MESSAGE_ID, oldMessageId, messageId));
	}
	...
	public NotificationChain basicSetFilterConditions(FilterConditions newFilterConditions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FoxBPMPackage.RECEIVE_MESSAGE__FILTER_CONDITIONS, oldFilterConditions, newFilterConditions);
	...
	public void setFilterConditions(FilterConditions newFilterConditions) {
		if (newFilterConditions != filterConditions) {
			...
			if (filterConditions != null)
				msgs = ((InternalEObject)filterConditions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FoxBPMPackage.RECEIVE_MESSAGE__FILTER_CONDITIONS, null, msgs);
			if (newFilterConditions != null)
				msgs = ((InternalEObject)newFilterConditions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FoxBPMPackage.RECEIVE_MESSAGE__FILTER_CONDITIONS, null, msgs);
			msgs = basicSetFilterConditions(newFilterConditions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FoxBPMPackage.RECEIVE_MESSAGE__FILTER_CONDITIONS, newFilterConditions, newFilterConditions));
	}
	...
	public NotificationChain basicSetProcessInstanceVariable(ProcessInstanceVariable newProcessInstanceVariable, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FoxBPMPackage.RECEIVE_MESSAGE__PROCESS_INSTANCE_VARIABLE, oldProcessInstanceVariable, newProcessInstanceVariable);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setProcessInstanceVariable(ProcessInstanceVariable newProcessInstanceVariable) {
		if (newProcessInstanceVariable != processInstanceVariable) {
			...
			if (processInstanceVariable != null)
				msgs = ((InternalEObject)processInstanceVariable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FoxBPMPackage.RECEIVE_MESSAGE__PROCESS_INSTANCE_VARIABLE, null, msgs);
			if (newProcessInstanceVariable != null)
				msgs = ((InternalEObject)newProcessInstanceVariable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FoxBPMPackage.RECEIVE_MESSAGE__PROCESS_INSTANCE_VARIABLE, null, msgs);
			msgs = basicSetProcessInstanceVariable(newProcessInstanceVariable, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FoxBPMPackage.RECEIVE_MESSAGE__PROCESS_INSTANCE_VARIABLE, newProcessInstanceVariable, newProcessInstanceVariable));
	}
	...
	public NotificationChain basicSetTokenVariable(TokenVariable newTokenVariable, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FoxBPMPackage.RECEIVE_MESSAGE__TOKEN_VARIABLE, oldTokenVariable, newTokenVariable);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTokenVariable(TokenVariable newTokenVariable) {
		if (newTokenVariable != tokenVariable) {
			...
			if (tokenVariable != null)
				msgs = ((InternalEObject)tokenVariable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FoxBPMPackage.RECEIVE_MESSAGE__TOKEN_VARIABLE, null, msgs);
			if (newTokenVariable != null)
				msgs = ((InternalEObject)newTokenVariable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FoxBPMPackage.RECEIVE_MESSAGE__TOKEN_VARIABLE, null, msgs);
			msgs = basicSetTokenVariable(newTokenVariable, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FoxBPMPackage.RECEIVE_MESSAGE__TOKEN_VARIABLE, newTokenVariable, newTokenVariable));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FoxBPMPackage.RECEIVE_MESSAGE__FILTER_CONDITIONS:
				return basicSetFilterConditions(null, msgs);
			case FoxBPMPackage.RECEIVE_MESSAGE__PROCESS_INSTANCE_VARIABLE:
				return basicSetProcessInstanceVariable(null, msgs);
			case FoxBPMPackage.RECEIVE_MESSAGE__TOKEN_VARIABLE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FoxBPMPackage.RECEIVE_MESSAGE__MESSAGE_ID:
				return getMessageId();
			case FoxBPMPackage.RECEIVE_MESSAGE__FILTER_CONDITIONS:
