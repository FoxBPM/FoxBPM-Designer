 ...
 *
 */
public class GroovyOperatorSelectionAdapter extends SelectionAdapter {
...
//	private Text text;
	...
	public GroovyOperatorSelectionAdapter(String operatorSymbol,IDocument document, StyledText control){
		super();
