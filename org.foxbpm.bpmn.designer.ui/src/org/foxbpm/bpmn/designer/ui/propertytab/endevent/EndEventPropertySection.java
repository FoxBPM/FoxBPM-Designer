...
public class EndEventPropertySection extends AbstractFoxBPMPropertySection {

	public EndEventPropertySection() {
	}

	@Override
	protected AbstractFoxBPMComposite createSectionRoot() {
		return new EndEventPropertyComposite(parent, SWT.NONE);
	}
	...
	public boolean appliesTo(IWorkbenchPart part, ISelection selection) {
		...
		boolean enabled = eObject instanceof EndEvent;
		return enabled;
	}
