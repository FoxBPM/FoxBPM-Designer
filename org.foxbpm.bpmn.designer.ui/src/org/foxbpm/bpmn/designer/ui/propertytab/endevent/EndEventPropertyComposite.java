package org.foxbpm.bpmn.designer.ui.propertytab.endevent;
...
public class EndEventPropertyComposite extends AbstractFoxBPMComposite{
	private EndEvent endEvent;
	private Text descText;
	private Text idText;
	private Text nameText;

	public EndEventPropertyComposite(Composite parent, int style) {
		super(parent, style);
	}

	@Override
	public void createUIBindings(EObject eObject) {
		endEvent = (EndEvent) eObject;
		bindText(Bpmn2Package.Literals.BASE_ELEMENT__ID, idText, endEvent);
		bindText(Bpmn2Package.Literals.FLOW_ELEMENT__NAME, nameText, endEvent);
