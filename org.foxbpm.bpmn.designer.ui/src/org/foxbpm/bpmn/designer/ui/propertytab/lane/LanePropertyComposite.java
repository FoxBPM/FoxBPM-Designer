...
public class LanePropertyComposite extends AbstractFoxBPMComposite{
	private Lane lane;
	private Text descText;
	private Text idText;
	private Text nameText;

	public LanePropertyComposite(Composite parent, int style) {
		super(parent, style);
	}
	...
	public void createUIBindings(EObject eObject) {
		lane = (Lane) eObject;
		bindText(Bpmn2Package.Literals.BASE_ELEMENT__ID, idText, lane);
		bindText(Bpmn2Package.Literals.LANE__NAME, nameText, lane);
