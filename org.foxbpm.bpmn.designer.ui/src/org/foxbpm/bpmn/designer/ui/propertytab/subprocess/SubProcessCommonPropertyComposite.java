...
public class SubProcessCommonPropertyComposite extends AbstractFoxBPMComposite{
	private SubProcess subProcess;
	private Text descText;
	private Text idText;
	private Text nameText;

	public SubProcessCommonPropertyComposite(Composite parent, int style) {
		super(parent, style);
	}

	@Override
	public void createUIBindings(EObject eObject) {
		subProcess = (SubProcess) eObject;
		bindText(Bpmn2Package.Literals.BASE_ELEMENT__ID, idText, subProcess);
		bindText(Bpmn2Package.Literals.FLOW_ELEMENT__NAME, nameText, subProcess);
