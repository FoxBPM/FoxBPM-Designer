...
public class ActorsPropertySection extends AbstractFoxBPMPropertySection {

	public ActorsPropertySection() {
	}

	@Override
	protected AbstractFoxBPMComposite createSectionRoot() {
		return new ActorsPropertyComposite(parent, SWT.NONE);
	}
