...
public class BusinessRuleTaskCommonPropertyComposite extends AbstractFoxBPMComposite{
	private BusinessRuleTask businessRuleTask;
	private Text descText;
	private Text idText;
	private Text nameText;

	public BusinessRuleTaskCommonPropertyComposite(Composite parent, int style) {
		super(parent, style);
	}

	@Override
	public void createUIBindings(EObject eObject) {
		businessRuleTask = (BusinessRuleTask) eObject;
		bindText(Bpmn2Package.Literals.BASE_ELEMENT__ID, idText, businessRuleTask);
		bindText(Bpmn2Package.Literals.FLOW_ELEMENT__NAME, nameText, businessRuleTask);
