...
public class UserTaskTaskPropertySection extends AbstractFoxBPMPropertySection {

	public UserTaskTaskPropertySection() {
	}

	@Override
	protected AbstractFoxBPMComposite createSectionRoot() {
		return new UserTaskTaskPropertyComposite(parent, SWT.NULL);
	}
