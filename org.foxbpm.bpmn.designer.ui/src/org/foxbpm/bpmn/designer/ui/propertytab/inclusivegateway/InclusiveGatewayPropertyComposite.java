...
public class InclusiveGatewayPropertyComposite extends AbstractFoxBPMComposite{
	private InclusiveGateway inclusiveGateway;
	private Text descText;
	private Text idText;
	private Text nameText;

	public InclusiveGatewayPropertyComposite(Composite parent, int style) {
		super(parent, style);
	}

	@Override
	public void createUIBindings(EObject eObject) {
		inclusiveGateway = (InclusiveGateway) eObject;
		bindText(Bpmn2Package.Literals.BASE_ELEMENT__ID, idText, inclusiveGateway);
		bindText(Bpmn2Package.Literals.FLOW_ELEMENT__NAME, nameText, inclusiveGateway);
