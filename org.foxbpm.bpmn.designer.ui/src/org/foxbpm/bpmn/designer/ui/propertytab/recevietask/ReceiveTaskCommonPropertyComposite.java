...
public class ReceiveTaskCommonPropertyComposite extends AbstractFoxBPMComposite{
	private ReceiveTask receiveTask;
	private Text descText;
	private Text idText;
	private Text nameText;

	public ReceiveTaskCommonPropertyComposite(Composite parent, int style) {
		super(parent, style);
	}

	@Override
	public void createUIBindings(EObject eObject) {
		receiveTask = (ReceiveTask) eObject;
		bindText(Bpmn2Package.Literals.BASE_ELEMENT__ID, idText, receiveTask);
		bindText(Bpmn2Package.Literals.FLOW_ELEMENT__NAME, nameText, receiveTask);
