...
public class IntermediateCatchEventPropertyComposite extends AbstractFoxBPMComposite{
	private IntermediateCatchEvent intermediateCatchEvent;
	private Text descText;
	private Text idText;
	private Text nameText;

	public IntermediateCatchEventPropertyComposite(Composite parent, int style) {
		super(parent, style);
	}
	...
	public void createUIBindings(EObject eObject) {
		...
		bindText(Bpmn2Package.Literals.BASE_ELEMENT__ID, idText, intermediateCatchEvent);
		bindText(Bpmn2Package.Literals.FLOW_ELEMENT__NAME, nameText, intermediateCatchEvent);
