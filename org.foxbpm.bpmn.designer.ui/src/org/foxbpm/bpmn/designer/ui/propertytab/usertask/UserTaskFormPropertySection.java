...
public class UserTaskFormPropertySection extends AbstractFoxBPMPropertySection {

	public UserTaskFormPropertySection() {
	}

	@Override
	protected AbstractFoxBPMComposite createSectionRoot() {
		return new UserTaskFormPropertyComposite(parent, SWT.NONE);
	}
