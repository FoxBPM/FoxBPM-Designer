...
public class ServiceTaskCommonPropertySection extends AbstractFoxBPMPropertySection {

	public ServiceTaskCommonPropertySection() {
	}

	@Override
	protected AbstractFoxBPMComposite createSectionRoot() {
		return new ServiceTaskCommonPropertyComposite(parent, SWT.NONE);
	}
