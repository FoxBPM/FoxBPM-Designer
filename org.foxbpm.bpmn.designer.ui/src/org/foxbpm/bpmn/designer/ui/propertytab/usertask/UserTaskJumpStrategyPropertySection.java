...
public class UserTaskJumpStrategyPropertySection extends AbstractFoxBPMPropertySection {

	public UserTaskJumpStrategyPropertySection() {
	}

	@Override
	protected AbstractFoxBPMComposite createSectionRoot() {
		return new UserTaskJumpStrategyComposite(parent, SWT.NONE);
	}
