package org.foxbpm.bpmn.designer.ui.propertytab.servicetask;
...
public class ServiceTaskCommonPropertyComposite extends AbstractFoxBPMComposite{
	private ServiceTask serviceTask;
	private Text descText;
	private Text idText;
	private Text nameText;

	public ServiceTaskCommonPropertyComposite(Composite parent, int style) {
		super(parent, style);
	}

	@Override
	public void createUIBindings(EObject eObject) {
		serviceTask = (ServiceTask) eObject;
		bindText(Bpmn2Package.Literals.BASE_ELEMENT__ID, idText, serviceTask);
		bindText(Bpmn2Package.Literals.FLOW_ELEMENT__NAME, nameText, serviceTask);
