...
public class TaskCommonPropertyComposite extends AbstractFoxBPMComposite{
	private Task task;
	private Text descText;
	private Text idText;
	private Text nameText;

	public TaskCommonPropertyComposite(Composite parent, int style) {
		super(parent, style);
	}
	...
	public void createUIBindings(EObject eObject) {
		task = (Task) eObject;
		bindText(Bpmn2Package.Literals.BASE_ELEMENT__ID, idText, task);
		bindText(Bpmn2Package.Literals.FLOW_ELEMENT__NAME, nameText, task);
