...
public class ExclusiveGatewayPropertyComposite extends AbstractFoxBPMComposite{
	private ExclusiveGateway exclusiveGateway;
	private Text descText;
	private Text idText;
	private Text nameText;

	public ExclusiveGatewayPropertyComposite(Composite parent, int style) {
		super(parent, style);
	}

	@Override
	public void createUIBindings(EObject eObject) {
		exclusiveGateway = (ExclusiveGateway) eObject;
		bindText(Bpmn2Package.Literals.BASE_ELEMENT__ID, idText, exclusiveGateway);
		bindText(Bpmn2Package.Literals.FLOW_ELEMENT__NAME, nameText, exclusiveGateway);
