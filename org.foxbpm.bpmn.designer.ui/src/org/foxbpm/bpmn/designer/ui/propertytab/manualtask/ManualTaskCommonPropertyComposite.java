package org.foxbpm.bpmn.designer.ui.propertytab.manualtask;
...
public class ManualTaskCommonPropertyComposite extends AbstractFoxBPMComposite{
	private ManualTask manualTask;
	private Text descText;
	private Text idText;
	private Text nameText;

	public ManualTaskCommonPropertyComposite(Composite parent, int style) {
		super(parent, style);
	}

	@Override
	public void createUIBindings(EObject eObject) {
		manualTask = (ManualTask) eObject;
		bindText(Bpmn2Package.Literals.BASE_ELEMENT__ID, idText, manualTask);
		bindText(Bpmn2Package.Literals.FLOW_ELEMENT__NAME, nameText, manualTask);
