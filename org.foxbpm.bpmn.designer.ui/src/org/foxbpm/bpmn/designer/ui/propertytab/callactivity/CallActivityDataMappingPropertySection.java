...
public class CallActivityDataMappingPropertySection extends AbstractFoxBPMPropertySection {

	public CallActivityDataMappingPropertySection() {
	}

	@Override
	protected AbstractFoxBPMComposite createSectionRoot() {
		return new CallActivityDataMappingComposite(parent, SWT.NONE);
	}
