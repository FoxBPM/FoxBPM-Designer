...
public class ManualTaskCommonPropertySection extends AbstractFoxBPMPropertySection {

	public ManualTaskCommonPropertySection() {
	}

	@Override
	protected AbstractFoxBPMComposite createSectionRoot() {
		return new ManualTaskCommonPropertyComposite(parent, SWT.NONE);
	}
