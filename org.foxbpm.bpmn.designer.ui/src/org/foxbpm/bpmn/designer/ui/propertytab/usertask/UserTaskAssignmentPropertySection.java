...
public class UserTaskAssignmentPropertySection extends AbstractFoxBPMPropertySection {

	public UserTaskAssignmentPropertySection() {
	}

	@Override
	protected AbstractFoxBPMComposite createSectionRoot() {
		return new UserTaskAssignmentPropertyComposite(parent, SWT.NONE);
	}
