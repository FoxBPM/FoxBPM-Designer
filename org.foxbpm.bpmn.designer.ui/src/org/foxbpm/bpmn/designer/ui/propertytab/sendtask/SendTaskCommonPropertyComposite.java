package org.foxbpm.bpmn.designer.ui.propertytab.sendtask;
...
public class SendTaskCommonPropertyComposite extends AbstractFoxBPMComposite{
	private SendTask sendTask;
	private Text descText;
	private Text idText;
	private Text nameText;

	public SendTaskCommonPropertyComposite(Composite parent, int style) {
		super(parent, style);
	}

	@Override
	public void createUIBindings(EObject eObject) {
		sendTask = (SendTask) eObject;
		bindText(Bpmn2Package.Literals.BASE_ELEMENT__ID, idText, sendTask);
		bindText(Bpmn2Package.Literals.FLOW_ELEMENT__NAME, nameText, sendTask);
