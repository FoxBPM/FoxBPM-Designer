...
public class OutputNewConnectorWizardPage extends WizardPage {
	 ...
	 * @param pageName
	 */
	public OutputNewConnectorWizardPage(String pageName) {
		super(pageName);
	}
	 ...
	 * @param titleImage
	 */
	public OutputNewConnectorWizardPage(EObject be, String pageName, String title, String desc, 
			ImageDescriptor titleImage, EList<Output> outputs) {
