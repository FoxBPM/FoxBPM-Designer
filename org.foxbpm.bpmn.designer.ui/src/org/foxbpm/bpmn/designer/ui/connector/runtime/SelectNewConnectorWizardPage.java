...
public class SelectNewConnectorWizardPage extends WizardPage {
	...
	private AddNewConnectorWizard wizard;
	 ...
	 * @param pageName
	 */
	public SelectNewConnectorWizardPage(String pageName) {
		super(pageName);
	}
	 ...
	 * @param titleImage
	 */
	public SelectNewConnectorWizardPage(EObject be, String pageName, String title, 
			ImageDescriptor titleImage, AddNewConnectorWizard wizard) {
