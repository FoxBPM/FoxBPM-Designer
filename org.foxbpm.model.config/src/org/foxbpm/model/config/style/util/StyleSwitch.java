...
public class StyleSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case StylePackage.ELEMENT_STYLE_CONFIG: {
				ElementStyleConfig elementStyleConfig = (ElementStyleConfig)theEObject;
				T result = caseElementStyleConfig(elementStyleConfig);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StylePackage.ELEMENT_STYLE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Element Style Config</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Element Style Config</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseElementStyleConfig(ElementStyleConfig object) {
		return null;
	}
