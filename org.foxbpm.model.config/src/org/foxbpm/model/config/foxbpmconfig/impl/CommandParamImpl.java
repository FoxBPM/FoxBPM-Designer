 ...
 * <ul>
 *   <li>{@link org.foxbpm.model.config.foxbpmconfig.impl.CommandParamImpl#getBizType <em>Biz Type</em>}</li>
 *   <li>{@link org.foxbpm.model.config.foxbpmconfig.impl.CommandParamImpl#getDataType <em>Data Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CommandParamImpl extends ParamImpl implements CommandParam {
	...
	protected EClass eStaticClass() {
		return FoxBPMConfigPackage.Literals.COMMAND_PARAM;
	}
	...
	public void setBizType(String newBizType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FoxBPMConfigPackage.COMMAND_PARAM__BIZ_TYPE, oldBizType, bizType));
	}
	...
	public void setDataType(String newDataType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FoxBPMConfigPackage.COMMAND_PARAM__DATA_TYPE, oldDataType, dataType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FoxBPMConfigPackage.COMMAND_PARAM__BIZ_TYPE:
				return getBizType();
			case FoxBPMConfigPackage.COMMAND_PARAM__DATA_TYPE:
				return getDataType();
		}
