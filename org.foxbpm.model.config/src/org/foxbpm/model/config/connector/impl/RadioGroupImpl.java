 ...
 * <ul>
 *   <li>{@link org.foxbpm.model.config.connector.impl.RadioGroupImpl#getChoices <em>Choices</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RadioGroupImpl extends WidgetImpl implements RadioGroup {
	 ...
	 * @ordered
	 */
	protected EList<Choices> choices;
	...
	protected EClass eStaticClass() {
		return ConnectorPackage.Literals.RADIO_GROUP;
	}
	 ...
	 * @generated
	 */
	public EList<Choices> getChoices() {
		if (choices == null) {
			choices = new EObjectContainmentEList<Choices>(Choices.class, this, ConnectorPackage.RADIO_GROUP__CHOICES);
		}
		return choices;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ConnectorPackage.RADIO_GROUP__CHOICES:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ConnectorPackage.RADIO_GROUP__CHOICES:
				getChoices().clear();
				getChoices().addAll((Collection<? extends Choices>)newValue);
				return;
		}
